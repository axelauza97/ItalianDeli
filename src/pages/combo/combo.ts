...
export class ComboPage {
      ...
      this.httpRequest.get(Constantes.getComboEspecialUrl(token)).then( (res: any) => {
          ...
          if(data != null ){
            data.forEach(element => {
              var dateIni=new Date(element.FECHA_INICIO);
              var dateFin=new Date(element.FECHA_FIN);
              if( now.getTime()>=dateIni.getTime() && now.getTime()<dateFin.getTime() && element.ACTIVO){
                this.combosEspeciales.push(element);
              }
            });
            console.log("COMBOS AQUÍ...................................>");
            console.log(this.combosEspeciales);
  ...
  abrirModalEspecial(event: Event){
    ...
    if(this.objetivo=="nuevo-combo"){
      ...
      let modal = this.modalCtrl.create(DetallePromocionalPage, {
        combosEspeciales : this.combosEspeciales,
        promo : this.combosEspeciales[0].NOMBRE,
        //combo : this.combos[0],
        combo : {"ID":0,"NOMBRE": this.combosEspeciales[0].NOMBRE , "DESCRIPCION":this.combosEspeciales[0].DESCRIPCION,"TAMANO":this.combosEspeciales[0].TAMANO_PIZZAS,"INGREDIENTE":this.combosEspeciales[0].INGREDIENTES_PIZZAS, "CANTIDAD":1 , "COSTO":this.combosEspeciales[0].PRECIO_PIZZAS, "IMAGEN_URL": this.combosEspeciales[0].IMAGEN_PORTADA, "PIZZAS": [] }
      });
      modal.present();
    //}
  ...
  abrirModalJueves(event: Event){
    ...
    if(this.objetivo=="nuevo-combo"){
      ...
      let modal = this.modalCtrl.create(DetallePromocionalPage, {
        ...
        id: this.combos[3].ID,
        combo : {"ID":this.combos[3].ID ,"NOMBRE": this.combos[3].NOMBRE , "DESCRIPCION":this.combos[3].DESCRIPCION, "CANTIDAD":1 , "COSTO":Number(this.combos[3].COSTO), "IMAGEN_URL": this.combos[3].IMAGEN_URL, "PIZZAS": [] } 
      })
      modal.present();
    }else{
      let modal = this.modalCtrl.create(DetallePromocionalPage, {
  ...
  abrirModalSabado(event: Event){
    ...
    if(this.objetivo=="nuevo-combo"){
      ...
      let modal = this.modalCtrl.create(DetallePromocionalPage, {
        ...
        id: this.combos[4].ID,
        combo : {"ID":this.combos[4].ID ,"NOMBRE": this.combos[4].NOMBRE , "DESCRIPCION":this.combos[4].DESCRIPCION, "CANTIDAD":1 , "COSTO":Number(this.combos[4].COSTO), "IMAGEN_URL": this.combos[4].IMAGEN_URL, "PIZZAS": [] } 
      })
      modal.present();
    }else{
      let modal = this.modalCtrl.create(DetallePromocionalPage, {
  ...
  abrirModalDomingo(event: Event){
    ...
    if(this.objetivo=="nuevo-combo"){
      ...
      let modal = this.modalCtrl.create(DetallePromocionalPage, {
        ...
        id: this.combos[5].ID,
        combo: {"ID":this.combos[5].ID ,"NOMBRE": this.combos[5].NOMBRE , "DESCRIPCION":this.combos[5].DESCRIPCION, "CANTIDAD":1 , "COSTO":Number(this.combos[5].COSTO), "IMAGEN_URL": this.combos[5].IMAGEN_URL, "PIZZAS": [] } 
      })
      modal.present();
    }else{
      let modal = this.modalCtrl.create(DetallePromocionalPage, {
