  ...
  mostrarMensaje2(titulo: string ,mensaje: string , objetivo: string){
   ...
   registrarToken(){
    try {
      ...
      this.httpRequest.post(Constantes.getRegistroTokenUrl(),datosregistro).then((data: any) => {
        var resJ =  data.json();
        if (resJ.STATUS == "OK") {
          //this.mostrarMensaje("", "Registro exitoso!!!");
          //this.navCtrl.setRoot(LoginPage);
          //this.login();
          console.log("Se registrooooooo token.....................");
          console.log(resJ);
        }else{
          console.log("No se registrooooooo token.....................");
          console.log(resJ);
        }
      });
    }
