...
@IonicPage()
@Component({
  selector: 'page-pizza-comboEspecialCinco',
  templateUrl: 'pizza-comboEspecialCinco.html',
})
export class PizzaComboEspecialCincoPage {
  ...
  pizzaCinco: PizzaPromo = { ingredientes: [], nombre: null, descripcion: "Pizza combo promocional", imgUrl: null, tamano: null, costo: null, cantidad: 1, borde: this.bordeElegidoChoice };
  ...
  constructor(
    ...
    //this.pizzaCinco = { ingredientes: [], nombre: null, descripcion: "Pizza combo promocional", imgUrl: null, tamano: null, costo: null, cantidad: 1 };
    ...
    try {
      ...
      this.httpRequest.get(Constantes.getTamanosUrl(token)).then((data: any) => {
        ...
        if (response["TAMANOS"] != undefined) {
          ...
          this.pizzaCinco.tamano = this.tamanoElegido;
  ...
  escucharEventos() {
    ...
    this.events.subscribe('seleccion-ingrediente', (ingrediente: IngredientesPromo) => {
      ...
      if (ingrediente.checked == true) {
        if (this.pizzaCinco.ingredientes.length > 1) {
          //this.pizzaCinco.ingredientes[0].checked = false;
          this.presentAlert("Ingredientes excedidos", "Solo puede elegir hasta dos ingredientes");
          return;
        } else {
          if (this.pizzaCinco.ingredientes.filter(function (e, index) { return e.id === ingrediente.id; }).length > 0) { //si ya contiene el elemento
            ingredienteIndex = this.pizzaCinco.ingredientes.map(function (x) { return x.id; }).indexOf(ingrediente.id);
            this.pizzaCinco.ingredientes[ingredienteIndex] = ingrediente;                                               //se reemplaza
          } else {
            this.pizzaCinco.ingredientes.push(ingrediente);                                                              //se agrega
          }
        }
        console.log(this.pizzaCinco.ingredientes)
      } else {
        this.removeItemFromArr(this.pizzaCinco.ingredientes, ingrediente);
  ...
  cambioTamano() {
    ...
    this.pizzaCinco.ingredientes = [];
    this.ingredientesCont = [];
    this.ingredientesEnabled = false;
    this.pizzaCinco.tamano = tamano;
    console.log(this.pizzaCinco.tamano)
    ...
    if(this.comboCurrent['COSTOS'].length==1){
      ...
      this.pizzaCinco.costo=Number(this.comboCurrent.COSTOS[0]);
      ...
      if((this.tamanos[0].id ==this.comboCurrent['TAMANOS'][0])&&(this.tamanos[1].id ==this.comboCurrent['TAMANOS'][1])){
        if(this.tamanoElegido.id ==this.comboCurrent['TAMANOS'][0]){
          ...
          this.pizzaCinco.costo=Number(this.comboCurrent.COSTOS[1]);
      ...
      if(this.tamanoElegido.nombreBase =="MEDIANA"){
        ...
        this.pizzaCinco.costo=Number(this.comboCurrent.COSTOS[2]);
  ...
  editarPizzas() {
    if (this.objetivo == 'editar-pizza') {
      ...
      this.promocionales.forEach((pizzaCinco) => {
        this.promocionales[0]["ingredientes"] = this.pizzaCinco.ingredientes;
        console.log(this.promocionales[0]['ingredientes']);
        //this.pizzaCinco.ingredientes = pizzaCinco.ingredientes;
        if (pizzaCinco.ingredientes.length < 2) {
  ...
  eventoSeleccion() {
    this.ingredientesCont.forEach(ingrediente => {
      this.pizzaCinco.ingredientes.push(ingrediente);
    });
  }
  eventoPublicar() {
    this.events.subscribe('seleccion-ingrediente', (ingrediente: IngredientesPromo) => {
  ...
  siguiente() {
    ...
    if (this.comboCurrent.ID==0) {
      if (this.pizzaCinco.ingredientes.length == 0) {
        ...
        if(this.tamanoElegido.nombreBase =="MEDIANA"){
          if(this.comboCurrent.INGREDIENTES[0]==2) {
            ...
            if (this.pizzaCinco.ingredientes.length == 1){
              ...
              return;
            }else if (this.pizzaCinco.ingredientes.length == 2){
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona un ingrediente más');
              return;
            }
            ...
            if (this.pizzaCinco.ingredientes.length == 1){
              ...
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona dos ingredientes más');
              return;
            }else if (this.pizzaCinco.ingredientes.length == 3){
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona un ingrediente más');
              return;
            }
            ...
            else if (this.pizzaCinco.ingredientes.length == 4){
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona un ingrediente más');
              return;
            }
          }
      ...
      /*else if (this.pizzaCinco.ingredientes.length == 0) {
          this.presentAlert('Faltan ingredientes', 'No has seleccionado ningún ingrediente');
          return;
      }*///else {
        if(this.comboCurrent.INGREDIENTES.length==3){
          if(this.tamanoElegido.nombreBase =="MEDIANA"){
            if(this.comboCurrent.INGREDIENTES[0]==5){
              if(this.pizzaCinco.ingredientes.length>5){
                var ingredientescpy=this.pizzaCinco.ingredientes;
                this.pizzaCinco.ingredientes=[];
                this.pizzaCinco.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaCinco.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
                this.pizzaCinco.ingredientes.push(ingredientescpy[ingredientescpy.length-3]);
                this.pizzaCinco.ingredientes.push(ingredientescpy[ingredientescpy.length-4]);
                this.pizzaCinco.ingredientes.push(ingredientescpy[ingredientescpy.length-5]);
              }
            }else if(this.comboCurrent.INGREDIENTES[0]==4){
              if(this.pizzaCinco.ingredientes.length>4){
                var ingredientescpy=this.pizzaCinco.ingredientes;
                this.pizzaCinco.ingredientes=[];
                this.pizzaCinco.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaCinco.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
              ...
              if(this.pizzaCinco.ingredientes.length>3){
                var ingredientescpy=this.pizzaCinco.ingredientes;
                this.pizzaCinco.ingredientes=[];
                this.pizzaCinco.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaCinco.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
              ...
              if(this.pizzaCinco.ingredientes.length>2){
                var ingredientescpy=this.pizzaCinco.ingredientes;
                this.pizzaCinco.ingredientes=[];
                this.pizzaCinco.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaCinco.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
          ...
          //console.log(this.pizzaCinco);
          //console.log(this.bordeElegidoChoice);
          this.eventoPublicar();
          this.pizzaCinco.nombre = "Pizza Uno";
          //this.pizzaCinco.costo=Number(this.comboCurrent.COSTOS[4]);
          this.pizzaCinco.borde = this.bordeElegidoChoice
          //this.abrirCombinaciones();
          this.combo = this.navParams.get("combo");
    
          //this.pizzaCinco.cantidad=30;
          if(this.combo['PIZZAS'].length>5){//si se regresa con el boton atras 
            ...
            this.combo['PIZZAS'].push(pizzascpy[pizzascpy.length-4]);
            this.combo['PIZZAS'].push(pizzascpy[pizzascpy.length-5]);
          }else if(this.combo['PIZZAS'].length==4){
            this.combo['PIZZAS'].push(this.pizzaCinco);
          }
          //this.costoTotal=Number(this.costoTotal)+Number(this.comboCurrent.COSTOS[4])

          /*if(this.comboCurrent.NUM_PIZZAS>4){
            this.abrirPizzaCinco();
          }else{*/
            this.abrirCombinaciones();
          //}
          ...
          if (this.comboCurrent.ID=='35') {
            ...
            this.pizzaCinco.costo = this.costoCombo / 2;
            this.tamanoEnvio = this.pizzaCinco.tamano;
            this.pizzaCinco.borde = this.bordeElegidoChoice
            this.abrirPizzaDos();
          } */ 
        }
  ...
  abrirPizzaDos() {
    ...
    if(this.objetivo == "nuevo-combo"){
      ...
      this.navCtrl.push(PizzaComboNuevoDosPage, {
        ...
        combo: this.combo,
        combos : this.combos,
        tamanoPizza: this.pizzaCinco.tamano,
