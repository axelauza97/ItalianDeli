...
export class RegistroFormPage {
  ...
  onSubmit(values){
    ...
    if(this.acuerdoPass){
      ...
      if(this.datosUsuario.correo!=null){
        datos.CORREO = this.datosUsuario.correo;
      }if(this.datosUsuario.apellidos!=null){
      ...
      }if(this.datosUsuario.nombres!=null){
        datos.NOMBRES = this.datosUsuario.nombres;
      }if(this.datosUsuario.telefono!=null){
        datos.TELEFONO = this.datosUsuario.telefono;
      }if(this.datosUsuario.telefonoEntrega!=null){
        datos.TELEFONO_ENTREGA = this.datosUsuario.telefonoEntrega;
      }if(this.datosUsuario.cedula!=null){
        datos.CEDULA = this.datosUsuario.cedula;
      }if(this.datosUsuario.imagenUrl!=null){
        datos.IMAGEN =  this.datosUsuario.imagenUrl;
      }if(this.datosUsuario.tel_fijo!!=null){
        datos.TEL_FIJO = this.datosUsuario.tel_fijo;
      }if(this.datosUsuario.direccion!=null){
        datos.DIRECCION = this.datosUsuario.direccion;
      }if(this.datosUsuario.direccionEntrega!=null){
        datos.DIRECCION_ENTREGA = this.datosUsuario.direccionEntrega;
      }
      ...
      this.httpRequest.post(Constantes.getRegistroFormUrl() , datos).then((res : any)=>{//datos
        ...
        console.log(resJ);
        if (resJ.STATUS == "OK") {
          this.mostrarMensaje("Registro exitoso!!!", "Te enviamos un correo especial, revisa tu bandeja de spam.");
