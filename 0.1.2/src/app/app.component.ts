...
import { Nav, App, Platform, MenuController, AlertController, ToastController, ModalController } from 'ionic-angular';
...
export class MyApp {
  ...
  constructor( 
    ...
    public App : App,
    private notificationservice: SecondFirebaseAppProvider,
   ...
   /*     {title: 'Carrito de Compras', component: CarritoPage, icon: 'cart'},
        ...
        { title: 'Y mi pizza?', component: ListaPedidosPage, icon: 'assets/imgs/pizza_icon.png', color:'green'},
  ...
  initializeApp() {
    this.platform.ready().then(async () => {
      ...
      (<any>window).FirebasePlugin.onMessageReceived((msg) => {
        try {
          //console.log(`Notification received - ${message}`);
          console.log(msg)
          console.log(msg.imagen_notificacion) 
          //if(msg.id=="1"){
           let modal = this.modalCtrl.create(notificacionPopUpPage, {
             url: msg.imagen_notificacion,  
             id:msg.id,
             message:msg.mensaje_notificacion
       ...
       //this.registrarToken();
       //console.log("Aqui se configura la segunda cuenta de firebase------------->")
       //console.log(window.localStorage.getItem("firebaseToken"))
       ...
       this.fcm.listenToNotifications().pipe(
        tap(msg => {
          ...
          /**
           * collapse_key: "com.innovasystem.pizzeria"
             from: "597411026712"
             google.delivered_priority: "high"
             google.message_id: "0:1604182024620009%3c634a3f3c634a3f"
             google.original_priority: "high"
             google.sent_time: 1604182024586
             google.ttl: 2419200
             id: "2"
           */
        })
...
/*const toast = this.toastCtrl.create({
       ...
       /*this.fcmPush.onNotification().subscribe(data => {
        console.log(data);
        if (data.wasTapped) {
  ...
  mostrarPopUp(){
    try {
      /*var datosregistro = {
        ...
        "token_firebase" : "",
        "message_type" : "FCM",
        "application_id" : "1:597411026712:android:ec03f8b579fa94ca52b06d"
      };
      let token = window.localStorage.getItem("userToken");
      let tokenFire = window.localStorage.getItem("firebaseToken");
      datosregistro.token = token;
      datosregistro.token_firebase = tokenFire;
      console.log("Cuerpo.....................");
      ...
      console.log("Erro registrooooooo token.....................");
        console.log(err);
