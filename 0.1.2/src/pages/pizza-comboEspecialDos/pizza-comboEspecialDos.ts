...
import { PizzaComboEspecialTresPage } from '../pizza-comboEspecialTres/pizza-comboEspecialTres';

@IonicPage()
@Component({
  selector: 'page-pizza-comboEspecialDos',
  templateUrl: 'pizza-comboEspecialDos.html',
})
export class PizzaComboEspecialDosPage {
  ...
  pizzaDos: PizzaPromo = { ingredientes: [], nombre: null, descripcion: "Pizza combo promocional", imgUrl: null, tamano: null, costo: null, cantidad: 1, borde: this.bordeElegidoChoice };
    ...
    try {
      ...
      this.httpRequest.get(Constantes.getTamanosUrl(token)).then((data: any) => {
        ...
        if (response["TAMANOS"] != undefined) {
          ...
          this.pizzaDos.tamano = this.tamanoElegido;
          ...
          this.pizzaDos.costo=Number(this.comboCurrent.COSTOS[0]);
    ...
    this.events.subscribe('seleccion-ingrediente', (ingrediente: IngredientesPromo) => {
      ...
      if (ingrediente.checked == true) {
        if (this.pizzaDos.ingredientes.length > 1) {
          //this.pizzaDos.ingredientes[0].checked = false;
        ...
        console.log(this.pizzaDos.ingredientes)
      } else {
        this.removeItemFromArr(this.pizzaDos.ingredientes, ingrediente);
  ...
  cambioTamano() {
    ...
    console.log(this.pizzaDos.tamano)
    ...
    if(this.comboCurrent['COSTOS'].length==1){
      ...
      if((this.tamanos[0].id ==this.comboCurrent['TAMANOS'][0])&&(this.tamanos[1].id ==this.comboCurrent['TAMANOS'][1])){
        if(this.tamanoElegido.id ==this.comboCurrent['TAMANOS'][0]){
          ...
          this.pizzaDos.costo=Number(this.comboCurrent.COSTOS[1]);
      ...
      if(this.tamanoElegido.nombreBase =="MEDIANA"){
        ...
        this.pizzaDos.costo=Number(this.comboCurrent.COSTOS[2]);
  ...
  editarPizzas() {
    if (this.objetivo == 'editar-pizza') {
      ...
      this.promocionales.forEach((pizzaDos) => {
        this.promocionales[0]["ingredientes"] = this.pizzaDos.ingredientes;
        console.log(this.promocionales[0]['ingredientes']);
        //this.pizzaDos.ingredientes = pizzaDos.ingredientes;
  ...
  siguiente() {
    ...
    if (this.comboCurrent.ID==0) {
      if (this.pizzaDos.ingredientes.length == 0) {
        ...
        if(this.tamanoElegido.nombreBase =="MEDIANA"){
          if(this.comboCurrent.INGREDIENTES[0]==2) {
            ...
            if (this.pizzaDos.ingredientes.length == 1){
              ...
              return;
            }else if (this.pizzaDos.ingredientes.length == 2){
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona un ingrediente más');
              return;
            }
            ...
            if (this.pizzaDos.ingredientes.length == 1){
              ...
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona dos ingredientes más');
              return;
            }else if (this.pizzaDos.ingredientes.length == 3){
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona un ingrediente más');
              return;
            }
            ...
            else if (this.pizzaDos.ingredientes.length == 4){
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona un ingrediente más');
              return;
            }
          }
      ...
      /*else if (this.pizzaDos.ingredientes.length == 0) {
        ...
        if(this.comboCurrent.INGREDIENTES.length==3){
          if(this.tamanoElegido.nombreBase =="MEDIANA"){
            if(this.comboCurrent.INGREDIENTES[0]==5){
              if(this.pizzaDos.ingredientes.length>5){
                var ingredientescpy=this.pizzaDos.ingredientes;
                this.pizzaDos.ingredientes=[];
                this.pizzaDos.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaDos.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
                this.pizzaDos.ingredientes.push(ingredientescpy[ingredientescpy.length-3]);
                this.pizzaDos.ingredientes.push(ingredientescpy[ingredientescpy.length-4]);
                this.pizzaDos.ingredientes.push(ingredientescpy[ingredientescpy.length-5]);
              }
            }else if(this.comboCurrent.INGREDIENTES[0]==4){
              if(this.pizzaDos.ingredientes.length>4){
                var ingredientescpy=this.pizzaDos.ingredientes;
                this.pizzaDos.ingredientes=[];
                this.pizzaDos.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaDos.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
              ...
              if(this.pizzaDos.ingredientes.length>3){
                var ingredientescpy=this.pizzaDos.ingredientes;
                this.pizzaDos.ingredientes=[];
                this.pizzaDos.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaDos.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
              ...
              if(this.pizzaDos.ingredientes.length>2){
                var ingredientescpy=this.pizzaDos.ingredientes;
                this.pizzaDos.ingredientes=[];
                this.pizzaDos.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaDos.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
          ...
          console.log("pizza Dos --------------------------------------->");
          console.log(this.pizzaDos);
          ...
          }else if(this.combo['PIZZAS'].length==1){
            this.combo['PIZZAS'].push(this.pizzaDos);
          }
          this.pizzaDos.costo=Number((this.comboCurrent.COSTO)/this.comboCurrent.NUM_PIZZAS);
        //this.costoTotal=Number(this.costoTotal)+Number(this.comboCurrent.COSTOS[1])
          if(this.comboCurrent.NUM_PIZZAS>2){
            this.abrirPizzaTres();
          }else{
            this.abrirCombinaciones();
          }
          ...
          this.eventoPublicar();
          this.pizzaDos.nombre = "Pizza Uno";
          //Little
          if (this.comboCurrent.ID=='35') {
            this.costoCombo = this.navParams.get('costo');
            this.pizzaDos.costo = this.costoCombo / 2;
            this.tamanoEnvio = this.pizzaDos.tamano;
            this.pizzaDos.borde = this.bordeElegidoChoice
            this.abrirPizzaDos();
          } */ 
        }
  ...
  abrirPizzaTres() {
    if(this.objetivo == "nuevo-combo"){
      //this.navCtrl.pop();
      this.navCtrl.push(PizzaComboEspecialTresPage, {
