...
import { PizzaComboEspecialCincoPage } from '../pizza-comboEspecialCinco/pizza-comboEspecialCinco';

@IonicPage()
@Component({
  selector: 'page-pizza-comboEspecialCuatro',
  templateUrl: 'pizza-comboEspecialCuatro.html',
})
export class PizzaComboEspecialCuatroPage {
  ...
  pizzaCuatro: PizzaPromo = { ingredientes: [], nombre: null, descripcion: "Pizza combo promocional", imgUrl: null, tamano: null, costo: null, cantidad: 1, borde: this.bordeElegidoChoice };
    ...
    try {
      ...
      this.httpRequest.get(Constantes.getTamanosUrl(token)).then((data: any) => {
        ...
        if (response["TAMANOS"] != undefined) {
          ...
          this.pizzaCuatro.tamano = this.tamanoElegido;
    ...
    this.events.subscribe('seleccion-ingrediente', (ingrediente: IngredientesPromo) => {
      ...
      if (ingrediente.checked == true) {
        if (this.pizzaCuatro.ingredientes.length > 1) {
          //this.pizzaCuatro.ingredientes[0].checked = false;
          this.presentAlert("Ingredientes excedidos", "Solo puede elegir hasta dos ingredientes");
          return;
        } else {
          if (this.pizzaCuatro.ingredientes.filter(function (e, index) { return e.id === ingrediente.id; }).length > 0) { //si ya contiene el elemento
            ingredienteIndex = this.pizzaCuatro.ingredientes.map(function (x) { return x.id; }).indexOf(ingrediente.id);
            this.pizzaCuatro.ingredientes[ingredienteIndex] = ingrediente;                                               //se reemplaza
          } else {
            this.pizzaCuatro.ingredientes.push(ingrediente);                                                              //se agrega
          }
        }
        console.log(this.pizzaCuatro.ingredientes)
      } else {
        this.removeItemFromArr(this.pizzaCuatro.ingredientes, ingrediente);
  ...
  cambioTamano() {
    ...
    console.log(this.pizzaCuatro.tamano)
    ...
    if(this.comboCurrent['COSTOS'].length==1){
      ...
      this.pizzaCuatro.costo=Number(this.comboCurrent.COSTOS[0]);
      ...
      if((this.tamanos[0].id ==this.comboCurrent['TAMANOS'][0])&&(this.tamanos[1].id ==this.comboCurrent['TAMANOS'][1])){
        if(this.tamanoElegido.id ==this.comboCurrent['TAMANOS'][0]){
          ...
          this.pizzaCuatro.costo=Number(this.comboCurrent.COSTOS[1]);
      ...
      if(this.tamanoElegido.nombreBase =="MEDIANA"){
        ...
        this.pizzaCuatro.costo=Number(this.comboCurrent.COSTOS[2]);
  ...
  editarPizzas() {
    if (this.objetivo == 'editar-pizza') {
      ...
      this.promocionales.forEach((pizzaCuatro) => {
        this.promocionales[0]["ingredientes"] = this.pizzaCuatro.ingredientes;
        console.log(this.promocionales[0]['ingredientes']);
        //this.pizzaCuatro.ingredientes = pizzaCuatro.ingredientes;
  ...
  siguiente() {
    ...
    if (this.comboCurrent.ID==0) {
      if (this.pizzaCuatro.ingredientes.length == 0) {
        ...
        if(this.tamanoElegido.nombreBase =="MEDIANA"){
          if(this.comboCurrent.INGREDIENTES[0]==2) {
            ...
            if (this.pizzaCuatro.ingredientes.length == 1){
              ...
              return;
            }else if (this.pizzaCuatro.ingredientes.length == 2){
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona un ingrediente más');
              return;
            }
            ...
            if (this.pizzaCuatro.ingredientes.length == 1){
              ...
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona dos ingredientes más');
              return;
            }else if (this.pizzaCuatro.ingredientes.length == 3){
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona un ingrediente más');
              return;
            }
            ...
            else if (this.pizzaCuatro.ingredientes.length == 4){
              this.presentAlert('Faltan ingredientes', 'Por favor selecciona un ingrediente más');
              return;
            }
          }
      ...
      /*else if (this.pizzaCuatro.ingredientes.length == 0) {
        ...
        if(this.comboCurrent.INGREDIENTES.length==3){
          if(this.tamanoElegido.nombreBase =="MEDIANA"){
            if(this.comboCurrent.INGREDIENTES[0]==5){
              if(this.pizzaCuatro.ingredientes.length>5){
                var ingredientescpy=this.pizzaCuatro.ingredientes;
                this.pizzaCuatro.ingredientes=[];
                this.pizzaCuatro.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaCuatro.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
                this.pizzaCuatro.ingredientes.push(ingredientescpy[ingredientescpy.length-3]);
                this.pizzaCuatro.ingredientes.push(ingredientescpy[ingredientescpy.length-4]);
                this.pizzaCuatro.ingredientes.push(ingredientescpy[ingredientescpy.length-5]);
              }
            }else if(this.comboCurrent.INGREDIENTES[0]==4){
              if(this.pizzaCuatro.ingredientes.length>4){
                var ingredientescpy=this.pizzaCuatro.ingredientes;
                this.pizzaCuatro.ingredientes=[];
                this.pizzaCuatro.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaCuatro.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
              ...
              if(this.pizzaCuatro.ingredientes.length>3){
                var ingredientescpy=this.pizzaCuatro.ingredientes;
                this.pizzaCuatro.ingredientes=[];
                this.pizzaCuatro.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaCuatro.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
              ...
              if(this.pizzaCuatro.ingredientes.length>2){
                var ingredientescpy=this.pizzaCuatro.ingredientes;
                this.pizzaCuatro.ingredientes=[];
                this.pizzaCuatro.ingredientes.push(ingredientescpy[ingredientescpy.length-1]);
                this.pizzaCuatro.ingredientes.push(ingredientescpy[ingredientescpy.length-2]);
          ...
          //console.log(this.pizzaCuatro);
          //console.log(this.bordeElegidoChoice);
          this.eventoPublicar();
          this.pizzaCuatro.nombre = "Pizza Cuatro";
          //this.pizzaCuatro.costo=Number(this.comboCurrent.COSTOS[3]);
          this.pizzaCuatro.borde = this.bordeElegidoChoice
          
          this.combo = this.navParams.get("combo");
    
          //this.pizzaCuatro.cantidad=30;
          if(this.combo['PIZZAS'].length>4){//si se regresa con el boton atras 
            ...
            this.combo['PIZZAS'].push(this.pizzaCuatro);
          }
          //this.costoTotal=Number(this.costoTotal)+Number(this.comboCurrent.COSTOS[3])
          this.pizzaCuatro.costo=Number((this.comboCurrent.COSTO)/this.comboCurrent.NUM_PIZZAS);
          ...
          this.eventoPublicar();
          this.pizzaCuatro.nombre = "Pizza Uno";
          //Little
          if (this.comboCurrent.ID=='35') {
            this.costoCombo = this.navParams.get('costo');
            this.pizzaCuatro.costo = this.costoCombo / 2;
            this.tamanoEnvio = this.pizzaCuatro.tamano;
            this.pizzaCuatro.borde = this.bordeElegidoChoice
            this.abrirPizzaDos();
          } */ 
        }
  ...
  abrirPizzaCinco() {
    if(this.objetivo == "nuevo-combo"){
      //this.navCtrl.pop();
      this.navCtrl.push(PizzaComboEspecialCincoPage, {
