  ...
  constructor(public navCtrl: NavController,
    ...
    this.year = this.currentTime.getFullYear();
           ...
           /* this.datosUsuario.correo = navParams.get("correo");
            ...
            if(navParams.get("correo")!=null){
              this.datosUsuario.correo = navParams.get("correo");
            }if(navParams.get("apellidos")!=null){
              this.datosUsuario.apellidos = navParams.get("apellidos");
            }if(navParams.get("nombres")!=null){
              this.datosUsuario.nombres = navParams.get("nombres");
            }if(navParams.get("telefono")!=null){
              this.datosUsuario.telefono = navParams.get("telefono");
            }if(navParams.get("telefonoEntrega")!=null){
              this.datosUsuario.telefonoEntrega = navParams.get("telefonoEntrega");
            }if(navParams.get("cedula")!=null){
              this.datosUsuario.cedula = navParams.get("cedula");
            }if(navParams.get("imagenUrl")!=null){
              this.datosUsuario.imagenUrl = navParams.get("imagenUrl");
            }if(navParams.get("tel_fijo")!=null){
              this.datosUsuario.tel_fijo = navParams.get("tel_fijo");
            }if(navParams.get("direccion")!=null){
              this.datosUsuario.direccion = navParams.get("direccion");
            }if(navParams.get("direccionEntrega")!=null){
              this.datosUsuario.direccionEntrega = navParams.get("direccionEntrega");
            }
            ...
            this.validations_form = this.formBuilder.group({
              ...
              telefonoEntrega:new FormControl('', Validators.compose([
                Validators.minLength(10),
                //Validators.required,
                Validators.pattern('^[0-9]*$')
              ])),
              ...
              direccionEntrega:new FormControl('', Validators.compose([
                //Validators.minLength(10),
                //Validators.required,
                //Validators.pattern('^[0-9]*$')
              ])),
...
**/
  ...
  //if(this.validarCedula(this.cedula)){
    ...
    if(this.telefonoEntrega != null){
      postData.append("TELEFONO_ENTREGA",   this.telefonoEntrega);
    } else {
      postData.append("TELEFONO_ENTREGA",   this.datosUsuario.telefonoEntrega);
    }
    ...
    if(this.direccionEntrega != null){
      postData.append("DIRECCION_ENTREGA",   this.direccionEntrega);
    } else {
      postData.append("DIRECCION_ENTREGA",   this.datosUsuario.direccionEntrega);
    }
    //console.log("Fecha-------------------------------------------------------->");
    //console.log(this.datosUsuario.DoB);
    ...
    //console.log(this.imagenPerfilBase64);
    //console.log("fin------------------------------------------------------->")
    if(this.datosUsuario.imagenUrl!=null || this.datosUsuario.imagenUrl!=""){
      ...
      if(this.imagenPerfilBase64 != null){ 
        ...
        if(this.datosUsuario.imagenUrl!=""){
          console.log("2------------------------------------------------------>")
